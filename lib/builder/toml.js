...
exports.context = exports.buildWithoutPreset = exports.build = exports.presetRwTomlConverter = exports.rwTomlBuilder = void 0;
const _1 = require(".");
...
function rwTomlBuilder(obj, starter) {
    ...
    if (source.to.isSome()) {
        return (0, result_1.ok)({ context, target: source.to.unwrap() });
    }
    if (starter == source) {
...
exports.build = build;
function buildWithoutPreset(obj) {
    const { context, customPreConverters } = obj;
    return (0, _1.buildWithPreConverters)({
        context,
...
exports.buildWithoutPreset = buildWithoutPreset;
function context(sources) {
    return {
        ...
        into() {
            return {
                sources: this.sources.map(({ path, content, }) => {
                    return {
                        path,
                        content,
                        from: (0, optional_1.none)(),
